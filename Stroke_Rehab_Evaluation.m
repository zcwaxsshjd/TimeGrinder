%% Stroke_Rehab_Evaluation
%
% Evaluate motor performance improvement of stroke patient during FES
% assisted rehab.
% 
% 
%% process raw data 
...
global Subject Dir ExpList TrialList N_sub_exp HandTraceOn PlotEMGOn TriggerAlignOn
...
% get trial list
[TrialList,N_sub_exp]	=   GetTrialList(Subject,Dir);

% plot setting
HandTraceOn = 1;    % Plot hand trace
PlotEMGOn = 0;      % Plot EMG
TriggerAlignOn = 1; % Align trials by trigger
